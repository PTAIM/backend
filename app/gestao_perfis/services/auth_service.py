...
from app.gestao_perfis.services.medico_service import MedicoService
...
class AuthService:
    ...
    def cadastrar_usuario(
        ...
        try:
            ...
            if crm:
                novo_medico = MedicoService.criar_perfil_medico(
                    db=db, usuario_id=novo_usuario.id, crm=crm
                )
